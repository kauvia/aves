...
class RenderSys {
	constructor(playerArr,npcArr, backgroundArr, camera, SCREEN_WIDTH, SCREEN_HEIGHT) {
	...
	update() {
		...
		for (let i in this.playerArr) {
			...
			this.playerArr[i].Sprite.attacking.x = objX - camX + this.SCREEN_WIDTH / 2;
			this.playerArr[i].Sprite.attacking.y = objY - camY + this.SCREEN_HEIGHT / 2;
